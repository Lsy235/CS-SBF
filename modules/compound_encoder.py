...
class AtomEmbedding(nn.Module):
    ...
    def __init__(self, embed_dim):
        ...
        embed = nn.Embedding(256+5, embed_dim)
    ...
    def forward(self, node_features):
        ...
        out_embed += self.embed_list[0](node_features)
        return out_embed
...
class BondEmbedding(nn.Module):
    ...
    def forward(self, edge_features):
        ...
        out_embed += self.embed_list[0](edge_features.type(torch.int))
        return out_embed
...
class BondFloatRBF(nn.Module):
    ...
    def __init__(self, embed_dim, rbf_params=None):
        ...
        centers, gamma = (np.arange(0, 2, 0.1), 10.0)
        rbf = RBF(centers, gamma)
        self.rbf_list.append(rbf)
        linear = nn.Linear(len(centers), embed_dim)
        self.linear_list.append(linear)
    ...
    def forward(self, bond_float_features):
        ...
        rbf_x = self.rbf_list[0](x.type(torch.float))
        out_embed += self.linear_list[0](rbf_x)
        return out_embed
...
class BondAngleFloatRBF(nn.Module):
    ...
    def __init__(self, embed_dim, rbf_params=None):
        ...
        centers, gamma = (np.arange(0, np.pi, 0.1), 10.0)
        rbf = RBF(centers, gamma)
        self.rbf_list.append(rbf)
        linear = nn.Linear(len(centers), embed_dim)
        self.linear_list.append(linear)
